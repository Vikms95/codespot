...
// User - Session
router.get("/api/session", [retrieveToken, verifyToken] as any);

router.post("/api/user", [validateUserCreation, createUser] as any);

router.post("/api/session", [validateUserLogin, loginUser] as any);
...
router.post("/api/post", upload.single("image"), createPost as any);

router.put("/api/posts/:postid", upload.single("image"), updatePost as any);
